...
var appHost = nconf.get('FANTASYMATCH_HOST');
...
passport.use(new FacebookStrategy({
		clientID: nconf.get('FANTASYMATCH_FB_APP_ID'),
		clientSecret: nconf.get('FANTASYMATCH_FB_APP_SECRET'),
		callbackURL: nconf.get('FANTASYMATCH_FB_APP_CALLBACK_URL'),
...
app.set('port', nconf.get('FANTASYMATCH_PORT') || 8001);
